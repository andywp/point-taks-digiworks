...
<div class="nav-header">
	<a href="{{ url('/') }}" target="_blank" title="Diglink.id" class="brand-logo">
		<img class="logo-abbr" src="{{ asset('assets/images/logos/dw.png') }}" alt="Diglink">
		<span class="brand-title">DIGIWORKS</span>
	</a>
            ...
            <div class="collapse navbar-collapse justify-content-between">
                <div class="header-left">
                    <div class="dashboard_bar">
                        @hasSection('header_title') @yield('header_title')  @else Dashboard @endif
                    </div>
                ...
                <ul class="navbar-nav header-right">
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                            <img src="{!! get_gravatar() !!}" width="20" alt="">
                        </a>
                        <div class="dropdown-menu dropdown-menu-end">
